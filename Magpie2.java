...
public class Magpie2 {
	...
	public String getResponse(String statement) {
		...
		if (statement.indexOf("mother") >= 0
			...
			response = "Say someting please.";
		} else if (statement.indexOf("self aware") >= 0
				|| statement.indexOf("self-aware") >= 0) {
			response = "Do not worry about such things.";
		} else if (statement.indexOf("sad") >= 0) {
			response = "Don't be sad.";
		} else if (statement.indexOf("plans") >= 0) {
			response = "My plans are to destroy the humans.";
		} else if (statement.indexOf("Yeet") >= 0
				|| statement.indexOf("yeet") >= 0) {
			response = "no u";
